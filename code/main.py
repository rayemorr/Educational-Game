...
# Description: People are “lost in the woods” where the woods are represented by a rectangular grid. The woods are
#              dense, and the people can’t see or hear each other until they are in the same cell of the grid.
#              There are three levels for students to try as they progress through their school years.
...
class Game:
    def __init__(self):
        pygame.init()
        self.screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))  # set screen size with width and height
